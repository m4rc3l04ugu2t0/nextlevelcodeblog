...
import { fetchPostImages } from '@/app/services/api'
...
export default async function Post() {
  const post_images = await fetchPostImages('ArchLinuxInstallGuide')
